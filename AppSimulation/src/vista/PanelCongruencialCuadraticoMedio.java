...
import generacion.CongruencialLinealCuadraticoMedio;
...
public class PanelCongruencialCuadraticoMedio extends JPanel {
	...
	public PanelCongruencialCuadraticoMedio() {
		...
		gbl_panelCaptura.rowHeights = new int[] { 0, 0, 0, 0, 0 };
		...
		valorD.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent evt) {
				char c = evt.getKeyChar();
				if (Character.isDigit(c) || evt.getKeyChar() == KeyEvent.VK_ENTER
		...
		valorD.setFont(new Font("Product Sans", Font.PLAIN, 16));
		valorD.setColumns(10);
		valorD.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "(D)",
				TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		valorD.setBackground(Color.WHITE);
		GridBagConstraints gbc_valorD = new GridBagConstraints();
		gbc_valorD.gridwidth = 2;
		gbc_valorD.insets = new Insets(0, 0, 5, 5);
		gbc_valorD.fill = GridBagConstraints.HORIZONTAL;
		gbc_valorD.gridx = 0;
		gbc_valorD.gridy = 1;
		panelCaptura.add(valorD, gbc_valorD);

		valorA = new JTextField();
		valorA.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"NUMERO PAR (A)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		valorA.setForeground(new Color(0, 0, 0));
		...
		valorA.setBackground(new Color(255, 255, 255));
		...
		valorB.setForeground(Color.BLACK);
		valorB.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent evt) {
				char c = evt.getKeyChar();
				if (Character.isDigit(c) || evt.getKeyChar() == KeyEvent.VK_ENTER
		...
		valorB.setFont(new Font("Product Sans", Font.PLAIN, 16));
		valorB.setColumns(10);
		valorB.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"NUMERO IMPAR (B)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		valorB.setBackground(Color.WHITE);
		GridBagConstraints gbc_valorB = new GridBagConstraints();
		gbc_valorB.gridwidth = 2;
		gbc_valorB.insets = new Insets(0, 0, 5, 5);
		gbc_valorB.fill = GridBagConstraints.HORIZONTAL;
		gbc_valorB.gridx = 0;
		gbc_valorB.gridy = 3;
		panelCaptura.add(valorB, gbc_valorB);
		
		valorC = new JTextField();
		valorC.setForeground(Color.BLACK);
		...
		valorC.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"NUMERO IMPAR (C)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		valorC.setBackground(Color.WHITE);
		GridBagConstraints gbc_valorC = new GridBagConstraints();
		gbc_valorC.gridwidth = 2;
		gbc_valorC.insets = new Insets(0, 0, 5, 0);
		...
		valorN.setForeground(Color.BLACK);
		valorN.addKeyListener(new KeyAdapter() {
			@Override
			public void keyTyped(KeyEvent evt) {
				char c = evt.getKeyChar();
				if (Character.isDigit(c) || evt.getKeyChar() == KeyEvent.VK_ENTER
		...
		valorN.setFont(new Font("Product Sans", Font.PLAIN, 16));
		valorN.setColumns(10);
		valorN.setBorder(new TitledBorder(
				new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)),
				"ITERACIONES (N)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		valorN.setBackground(Color.WHITE);
		GridBagConstraints gbc_valorN = new GridBagConstraints();
		gbc_valorN.gridwidth = 2;
		gbc_valorN.insets = new Insets(0, 0, 5, 0);
		gbc_valorN.fill = GridBagConstraints.HORIZONTAL;
		gbc_valorN.gridx = 2;
		gbc_valorN.gridy = 1;
		panelCaptura.add(valorN, gbc_valorN);
		...
		gbc_panelBtnProducto.insets = new Insets(0, 0, 5, 0);
	...
	public boolean areEmpty() {
		return semilla.getText().equalsIgnoreCase("") || valorA.getText().equalsIgnoreCase("");
	}
	...
	public void calcularValores() {
		if (!areEmpty()) {
			...
			int d = Integer.parseInt(valorD.getText());
			...
			CongruencialLinealCuadraticoMedio congruencialLinealCuadraticoMedio = new CongruencialLinealCuadraticoMedio(
					x0, d, a, b, c, n);
			congruencialLinealCuadraticoMedio.getNumbers();
			listaX0 = congruencialLinealCuadraticoMedio.getListaX0();
			listaX = congruencialLinealCuadraticoMedio.getListaX();
			listaR = congruencialLinealCuadraticoMedio.getListaR();
