...
import generacion.CongruencialLinealMultiplicativo;
...
public class PanelCongruencialLinealMultiplicativo extends JPanel {
	...
	public PanelCongruencialLinealMultiplicativo() {
		...
		valorA.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "(A)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		valorM.setBorder(new TitledBorder(new EtchedBorder(EtchedBorder.LOWERED, new Color(255, 255, 255), new Color(160, 160, 160)), "(M)", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	public boolean areEmpty() {
		return semilla.getText().equalsIgnoreCase("") || valorM.getText().equalsIgnoreCase("");
	}
	...
	public void calcularValores() {
		if (!areEmpty()) {
			...
			CongruencialLinealMultiplicativo congruencialLinealMultiplicativo = new CongruencialLinealMultiplicativo(x0,a,m);
			congruencialLinealMultiplicativo.getNumbers();
			listaX0 = congruencialLinealMultiplicativo.getListaX0();
			listaX = congruencialLinealMultiplicativo.getListaX();
			listaR = congruencialLinealMultiplicativo.getListaR();
