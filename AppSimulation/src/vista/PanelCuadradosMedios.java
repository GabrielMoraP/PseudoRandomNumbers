...
public class PanelCuadradosMedios extends JPanel {
	...
	public PanelCuadradosMedios() {
		setBorder(new EmptyBorder(15, 15, 15, 15));
		setBackground(new Color(28, 32, 57));
		GridBagLayout gridBagLayout = new GridBagLayout();
		gridBagLayout.columnWidths = new int[] { 0, 0 };
		gridBagLayout.rowHeights = new int[] { 0, 0, 50 };
	...
	public void calcularValores() {
		if (!areEmpty()) {
			...
			CuadradosMedios cuadradosMedios = new CuadradosMedios(x0, n);
			cuadradosMedios.getNumbers();
			listaX0 = cuadradosMedios.getListaX0();
			listaY = cuadradosMedios.getListaY();
			listaX = cuadradosMedios.getListaX();
			listaR = cuadradosMedios.getListaR();
